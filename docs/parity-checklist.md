...
> 状态：**M8 轮**（2026-09-18，原骨架轮 2026-09-15）。本表是 AC-1 的判据本身——AC-1 写的是「按本清单逐项断言，每项在 TUI 与 Web 各有一个 e2e 用例」。
...
| 10 | 模型切换 | 🟡 对话里 `/model <名字> [provider]` | ✅ 工具栏下拉（`model.list`），清单里没有的可以手填（PRD-M8-010 AC-5） | ⬜ | ⬜ |

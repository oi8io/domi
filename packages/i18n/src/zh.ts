...
export const zh = {
  ...
  'web.composer.addNote': '补充',
  'web.composer.addNoteHint': '它还在跑：这句话会在下一步开始前送到',
  'web.composer.noteTextOnly': '运行中的补充只能是文字；附件、文件、技能和引用等这一轮结束再发',
  'web.composer.interrupt': '停止',
  'web.composer.interruptHint': '停下这一轮：已输出的内容保留，正在跑的工具会被中止',
  'web.notes.queued': '排队中 · 下一步送达（{n}）',
  'web.notes.withdraw': '撤回',
  ...
  'web.session.notePlaceholder': '它还在跑——想补充什么，下一步就送到（Enter 发送）',
  ...
  'core.plan.header': '计划',
  'core.plan.question': '按这个计划做吗？',
  'core.plan.approve': '批准，开始执行',
  'core.plan.approveHint': '在这个会话里按步骤做',
  'core.plan.approveAsTask': '批准并转成长任务',
  'core.plan.approveAsTaskHint': '拆成后台长任务，按步骤逐个执行',
  ...
  'tui.cmd.unqueue': '撤回最后一条排队中的补充',
  'tui.notes.queued': '排队中 · 下一步送达（{n}）',
  'tui.notes.none': '没有排队中的补充',
  'tui.notes.withdrawn': '已撤回：{text}',
  'tui.notes.onlyText': '跑着的时候只能补充文字，或用 /unqueue 撤回；Esc 停下这一轮',
  'tui.interrupted': '已请求停下这一轮',

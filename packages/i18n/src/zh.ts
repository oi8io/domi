...
export const zh = {
  ...
  'web.questions.title': '需要你决定',
  'web.questions.review': '核对',
  'web.questions.other': '其他',
  'web.questions.otherPlaceholder': '自己写…',
  'web.questions.multi': '可多选',
  'web.questions.unanswered': '未回答',
  'web.questions.decline': '不回答',
  'web.questions.next': '下一题',
  'web.composer.mode': '确认模式',
  'web.composer.modeOnDemand': '按需',
  'web.composer.modeOnDemandHint': '按需（推荐）：有规则放就放行，没规则才问',
  'web.composer.modeAlwaysAsk': '每次都问',
  'web.composer.modeAlwaysAskHint': '每次都问：危险操作无论规则如何都要本人确认',
  'web.composer.modeAllowAll': '全部放行',
  'web.composer.modeAllowAllHint':
    '全部放行：跳过所有确认直接执行（包括删除、shell、联网）；只有你在配置里写的 deny 规则仍然生效',
  ...
  'core.ev.permissionsMode': '确认模式切到「{mode}」',
  'core.ask.unanswered': '用户没有回答',
  ...
  'tui.questions.keys': '←→ 切题 · ↑↓ 移动 · 回车/空格 选 · a–d 直选 · n 不回答',
  'tui.questions.editing': '正在写「其他」：回车或 Esc 写完',
  'tui.questions.submitKeys': '回车提交 · ← 回去改 · n 不回答',
...
`,
  ...
  'trace.permissionsMode': '确认模式：{mode}',

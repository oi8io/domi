/**
 * 图标 —— 从原型 docs/ui-redesign/index.html 收来的内联 SVG（ADR-027：不引图标库）。
 * 全部 24×24 视口、描边 currentColor，尺寸由 size 控制。
 */
...
function base(children: ReactNode) {
  return function Icon({ size = 14, ...rest }: IconProps): ReactElement {
    return (
      <svg
        width={size}
        height={size}
...
export const IconFolder = base(<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />)
export const IconFolderPlus = base(
  <>
...
export const IconMoon = base(<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />)
export const IconChevron = base(<polyline points="6 9 12 15 18 9" />)
...
export const IconQuote = base(
  <>
    <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.76-2-2-2H4c-1.25 0-2 .75-2 1.97V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .01-1 1.03V20c0 1 0 1 1 1z" />
